			...
			<div class="xMAlign-inner">
				<form name="xLoginForm" action="<?php echo $login_action ?>" method="post">
                    ...
                    <?php if ($options['HOSTING_PROFILE']) { ?>
                        <a href="<?php echo $login_action . '?provider=facebook&amp;remote_redirect=' . urlencode($options['SITE_HOST_ADDRESS'] . $SITE_ABS_ROOT . '_api/auth/login') ?>" class="social_button social_button_facebook"><span class="icon-facebook"></span>Log in with Facebook</a>
                        <a href="<?php echo $login_action . '?provider=google&amp;remote_redirect=' . urlencode($options['SITE_HOST_ADDRESS'] . $SITE_ABS_ROOT . '_api/auth/login')  ?>" class="social_button social_button_google"><span class="icon-google-plus"></span>Log in with Google</a>
