...
function errorHandler($errno, $errstr, $errfile, $errline, $context = false, $bDoReturn = false) {
    ...
    $plain = '';
    switch($errno){
        case E_ERROR:               $str .= "Error";                  $plain .= "Error -";                  break;
        case E_WARNING:             $str .= "Warning";                $plain .= "Warning -";                break;
        case E_PARSE:               $str .= "Parse Error";            $plain .= "Parse Error -";            break;
        case E_NOTICE:              $str .= "Notice";                 $plain .= "Notice -";                 break;
        case E_CORE_ERROR:          $str .= "Core Error";             $plain .= "Core Error -";             break;
        case E_CORE_WARNING:        $str .= "Core Warning";           $plain .= "Core Warning -";           break;
        case E_COMPILE_ERROR:       $str .= "Compile Error";          $plain .= "Compile Error -";          break;
        case E_COMPILE_WARNING:     $str .= "Compile Warning";        $plain .= "Compile Warning -";        break;
        case E_USER_ERROR:          $str .= "User Error";             $plain .= "User Error -";             break;
        case E_USER_WARNING:        $str .= "User Warning";           $plain .= "User Warning -";           break;
        case E_USER_NOTICE:         $str .= "User Notice";            $plain .= "User Notice -";            break;
        case E_STRICT:              $str .= "Strict Notice";          $plain .= "Strict Notice -";          break;
        case E_RECOVERABLE_ERROR:   $str .= "Recoverable Error";      $plain .= "Recoverable Error -";      break;
        default:                    $str .= "Unknown error ($errno)"; $plain .= "Unknown error ($errno) -"; break;
    }
