...
$settingsDefinition = array(
	...
	'navigation' => array(
		...
		'landingSectionMenuVisible' =>  array('format' => 'select',	'default' => 'yes',	'values' => array('yes', 'no'),		'title' => I18n::_('Is menu visible in first section?'),    'description' => I18n::_('Choose "no" to hide the menu in first section.')),
