...
return [
    ...
    'Sections' => 'Działy',
    /* column */
    'Title as displayed in main menu' => 'Tytuł (w głównym menu)',
    /* column */
    'Type' => 'Typ',
    /* column */
    'Details' => 'Ustawienia',
    /* column */
    'Is published?' => 'Publikowany?',
    /* column */
    'Delete' => 'Kasować',
    /* button */
    'create new section' => 'stworzyć nowy dział',
    /* button */
    'delete' => 'kasować',
    ...
    'Template' => 'Projekt',
    /* help text */
    'Templates are like skins or themes for your site. You can choose one template from the ones installed in your templates folder. To add a new template to this list, upload it to the templates folder via FTP.' => 'Projekty są "skórki" lub tematy, które zmieniają umiejscowienie elementów strony lub wygląd.',
    ...
    /* help text */
    'Your name will be put in a meta-tag in the code of your site. You can choose any name ;)' => 'Twoje imię będzie zapisane w kodzie strony w znaczniku meta tag. Imię może być dowolne.',
    /* setting name */
    'Page title (title bar)' => 'Tytuł strony',
    /* help text */
    'Text that appears in the bowser title bar' => 'Tekst, który jest widoczny na górze przeglądarki',
    /* setting name */
    ...
    /* setting name */
    'Is first section visible in menu?' => 'Czy pierwszy dział jest widoczny w głównym menu?',
    /* help text */
    ...
    /* setting name */
    'Show menu in first section' => 'Pokazać menu w pierwszym dziale?',
    /* help text */
    'Choose "no" to hide the menu in first section.' => 'Wybierz "No", aby schować menu w pierwszym dziale.',
    /* setting name */
    'Always auto-select a submenu item?' => 'Wybrać automatycznie pierwszy rozdział?',
    /* help text */
    'Choose "yes" to automatically select the first submenu item when clicking on a menu item. This works only when there is a submenu.' => 'Wybierz "Yes", aby automatycznie wybrać pierwszy rozdział, klikając na nim w menu.',
    ...
    /* help text */
    'Distance in pixels for snap-to-grid dragging.' => 'Rozmiar komórki w pikselach. Jeżeli jest większy nić 1, wtedy elementy będą przylepione do tej niewidocznej siatki snap to grid).',

    /* setting tab */
    'Entry layout' => 'Wygląd wpisu',
    /* setting name */
    'Small image width' => 'Szerokość małego obrazu',
    /* setting name */
    'Small image height' => 'Wysokość małego obrazu',
    /* help text */
    'Maximum size of a small image (visible if \'Small images\' are switched on in the gallery editor). These settings don\'t affect original image.' => 'Maksymalny rozmiar małego obrazu. Będzie to widoczne, kiedy w edytorze galerii będzie włączony "Małe obrazy"',
    /* setting name */
    'Large image width' => 'Szerokość dużego obrazu',
    /* setting name */
    'Large image height' => 'Wysokość dużego obrazu',
    /* help text */
    'Maximum size of a large image (visible if \'Large images\' are switched on in the gallery editor). These settings don\'t affect original image.' => 'Maksymalny rozmiar małego obrazu. Będzie on widoczny, kiedy w edytorze galerii zostanie włączony "Duże obrazy"',
    ...
    /* setting name */
    'Caption alignment' => 'Pozycja napisu',
    /* help text */
    'Positioning of the image caption text.' => 'Pozycja napisu obrazu',
    /* setting subcategory */
    'Image gallery appearance:' => 'Wygląd galerii obrazów:',
    /* setting name */
    'Show slideshow image numbers' => 'Pokazywać numery obrazów w pokazie slajdów',
    /* help text */
    'Set the default state of image number visibility in slideshow galleries.' => 'Ustanawia, czy domyślnie pokazywać numery obrazów w galeriach pokazów slajdów.',
    /* setting name */
    'Video player' => 'Wygląd video player',
    /* help text */
    'Choose between the two visually different players for your video files.' => 'Wybierz pomiędzy dwoma różnymi odtwarzaczami wideo.',
    ...
    /* setting tab */
    'General font settings' => 'Ustawienia czcionki',
    /* setting name */
    'Color' => 'Kolor',
    /* setting name */
    'Font face' => 'Czcionka liter',
    /* setting name */
    'Font size' => 'Rozmiar czcionki',
    /* setting name */
    'Font weight' => 'Pogrubienie czcionki',
    /* setting name */
    'Font style' => 'Styl czcionki',
    /* setting name */
    'Font variant' => 'rodzaj czcionki',
    /* setting name */
    'Line height' => 'Wysokość wiersza',
    /* help text */
    'Height of text line. Use em, px or % values or the default value "normal"' => 'Odległość pomiędzy podstawą dwóch linijek tekstu. Używaj wartości "em", "px" lub "%", oraz domyślną wartość "normal"',
    ...
    /* setting name */
    'Visited link color' => 'Kolor odwiedzonego linku',
    /* setting name */
    'Link color when hovered' => 'Kolor aktywnego (hover) linku',
    /* setting name */
    'Link color when clicked' => 'Kolor naciśniętego (clicked) linku',
    /* setting name */
    'Link decoration' => 'Dekoracja linku',
    /* setting name */
    'Visited link decoration' => 'Dekoracja odwiedzonego linku',
    /* setting name */
    'Link decoration when hovered' => 'Dekoracja aktywnego (hover) linku',
    /* setting name */
    'Link decoration when clicked' => 'Dekoracja naciśniętego  (clicked) linku',
    ...
    /* setting name */
    'Is background image enabled?' => 'Obraz tła uaktywniony?',
    /* setting name */
    'Background image' => 'Obraz tła',
    /* help text */
    'Picture to use for page background.' => 'Wybierz obraz tła',
    /* setting name */
    'Background tiling' => 'Powtórzenie tła',
    /* help text */
    'How the background fills the screen?' => 'Jak tło wypełnia ekran?',
    /* setting name */
    'Background alignment' => 'Ustawienie tła',
    /* help text */
    'Where the background image is positioned?' => 'Pozycja obrazu tła',
    /* setting name */
    'Background position' => 'Pozycja tła',
    /* help text */
    'Sets how background behaves in relation with the browser window.' => 'Jak zachowuje się obraz tła, jeżeli zmieniany jest rozmiar okna przeglądarki',

    /* setting name */
    'Background button type' => 'Typ przycisków tła',
    /* help name */
    'Select type for background gallery buttons.' => 'Wybierz typ przycisków dla galerii tła',

    /* setting name */
    'Content position' => 'Pozycja treści',
    /* setting name */
    'Text alignment' => 'Ustawienie treści',
    /* setting name */
    'Width of content area' => 'Szerokość pasma treści',
    /* setting name */
    'Page margins' => 'Krawędzi strony',
    /* help text */
    'How far the content is from browser edges.' => 'Jaka jest odległość od treści strony do brzegów przeglądarki.',
    /* setting name */
    'Top menu margins' => 'Górna krawędź menu',
    /* help text */
    'How big is the distance from the top menu to the other page elements' => 'Odległość pomiędzy głównym menu i innymi elementami strony',

    /* setting tab */
    'Page heading' => 'Tytuł strony',
    /* setting name */
    'Header image' => 'Obraz nagłówka strony',
    /* help text */
    'Picture to use instead of text.' => 'Obraz, który będzie wykorzystany zamiast tekstu w nagłówku strony.',
    /* help text */
    'How far the heading is from other elements in page.' => 'Jak daleko nagłówek strony znajduje się od innych elementów.',
    /* help text */
    'How far the menu is form other elements in page.' => 'Jak daleko menu strony znajduje się od innych elementów strony.',

    /* setting tab */
    'Main menu' => 'Główne menu',
    /* setting name */
    'Menu items separator' => 'Symbol oddzielający menu',
    /* setting name */
    'Space width around separator' => 'Odległość wokół symbolu oddzielającego',
    /* help text */
    'The distance from the separator to the menu item on both sides' => 'Odległość pomiędzy symbolem oddzielającym oraz jednostką menu',

    /* setting tab */
    'Submenu' => 'Menu podrzędne',

    /* setting name */
    'Entry margins' => 'Krawędzie wpisu',
    /* help text */
    'Margins around entries.' => 'Krawędzie wokół wpisu.',
    /* setting name */
    'Gallery position' => 'Pozycja galerii',
    /* setting name */
    'Default gallery type' => 'Domyślny typ galerii',
    /* help text */
    'Slideshow means that an image menu plus only one image is visible at a time. Row means that all images are visible.' => '"Pokaz slajdów" oznacza, że widoczny jest obraz z cyframi, natomiast w "Rzędzie" oznacza, że wszystkie obrazy są widoczne od razu w rzędzie.',
    /* setting name */
    'Space between images in row and column' => 'Odległość pomiędzy obrazami w wierszu i kolumnie',
    /* help text */
    'Horizontal/vertical space between images when gallery is in "row"/"column" mode' => 'Odległość horyzontalna/wertykalna pomiędzy obrazami w trybach "row"/"column"',
    /* setting name */
    'Gallery margins' => 'Krawędzie obrazu',
    /* help text */
    'Margin around gallery block' => 'Krawędzie wokół bloku galerii',
    /* setting name */
    'Display tags by each entry' => 'Pokazywać Tagi przy każdym wpisie',
    /* help text */
    'This determines whether people will see tags you set for each entry. Regardless of this settting, tags still will make up the main menu.' => 'To ustala, czy pokazywać Tagi przy każdym wpisie. Niezależnie od ustawień, Tagi będą widoczne w głównym menu.',
    /* setting name */
    'Date format in entries' => 'Format daty dla wpisów',
    /* setting name */
    'Date separator' => 'Oddzielać daty',
    /* help text */
    'Separator symbol that divides year, month and day' => 'Symbol, który oddziela rok, miesiąc i dzień',
    /* setting name */
    'Time separator' => 'Symbol oddzielający cyfry godziny',

    /* setting tab */
    'Entry heading' => 'Tytuł wpisu',
    /* help text */
    'How far the entry heading is form other elements in page.' => 'Jak daleko tytuł wpisu znajduje się od innych elementów strony.',

    /* setting tab */
    'Entry footer' => 'Stopka wpisu',
    ...
    /* setting tab */
    'Page layout' => 'Wygląd strony',
    /* setting name */
    'Entry text max width' => 'Maksymalna szerokość wpisu',
    /* help text */
    'Width of texts in the entries. This does not apply to the width of images.' => 'Szerokość tekstu we wpisach',
    /* setting name */
    'How far content is from page top?' => 'Odległość treści strony od góry strony.',
    /* help text */
    'The vertical distance between the top of the page and the content area.' => 'Odległość wertykalna od góry strony do treści strony.',
    /* setting name */
    'How far content is from sidebar?' => 'Odległość treści strony od paska bocznego.',
    /* help text */
    'The horizontal distance between the menu and the content area.' => 'Odległość horyzontalna pomiędzy głównym menu i treści strony.',

    /* setting name */
    'Space between entries' => 'Odległość pomiędzy wpisami',
    /* help text */
    'Distance from entry to entry. In pixels.' => 'Odległość od wpisu do wpisu. W pikselach.',

    /* setting name */
    'Width' => 'Szerokość',
    /* setting name */
    'Left margin' => 'Odległość od lewej strony',
    /* help text */
    'How far the sidebar is from the left side of the screen.' => 'Jak daleko pasek boczny znajduje się od lewej krawędzi strony?',
    /* setting name */
    'Top padding' => 'Odległość od góry',
    /* help text */
    'How far the header is from the top of the screen?' => 'Jak daleko pasek boczny znajduje się od góry strony?',
    /* setting name */
    'Space between header and menu' => 'Odległość pomiędzy nagłówku i głównym menu.',
    /* help text */
    'How far the menu is from the header text or header image.' => 'Jak daleko znajduje się główne menu od tekstu nagłówka lub obraza?',
    /* setting name */
    'Heading text color' => 'Kolor tekstu nagłówka',
    /* setting name */
    'Is transparent?' => 'Jest przezroczysta?',
    /* setting name */
    'Heading font' => 'Czcionka liter w nagłówku',
    /* setting name */
    'Heading font size' => 'Rozmiar liter w nagłówku',
    /* setting name */
    'Heading font weight' => 'Pogrubienie liter w nagłówku',
    /* setting name */
    'Heading font style' => 'Styl liter w nagłówku',
    /* setting name */
    'Heading font variant' => 'Styl liter w nagłówku',
    /* setting name */
    'Heading line height' => 'Wysokość wiersza w nagłówku',

    /* setting name */
    'Image size ratio' => 'Proporcja rozmiaru obrazu',
    /* help text */
    'Images in the first page layout will be resized by this ratio. Think of it as percentage, e.g., 0.7 = 70% of the original image size.' => 'Rozmiary obrazów na pierwszej stronie będą zmienione według tej proporcji. Na przykład, 0.7 = 70% z pierwotnego rozmiaru.',
    /* setting name */
    'Images have shadows?' => 'Czy obrazy mają cienie?',
    /* setting name */
    'Images wiggle on mouse-over?' => 'Czy obrazy poruszają się po najechaniu na nich myszką?',

    /* setting name */
    'Color when opened' => 'Kolor otwartego elementu',
    /* setting name */
    'Decoration when opened' => 'Dekoracja otwartego elementu',

    // Translations for White template

    /* setting name */
    'Empty space on top' => 'Puste miejsce na górze',
    /* setting name */
    'Empty space on bottom' => 'Puste miejsce na dole',
    /* setting name */
    'How far content is from menu?' => 'Jak daleko treść strony znajduje się od głównego menu?',
    /* setting name */
    'Width of the left column' => 'Szerokość lewej kolumny',

    // Translations for Messy template

    /* setting name */
    'Space between images and image navigation' => 'Odległość pomiędzy obrazem i elementem nawigacji',
    /* help text */
    'Vertical space between images and image navigation (the digits below the image) when gallery is in "slideshow" mode' => 'Odległość wertykalna pomiędzy obrazem i elementem nawigacji (pod obrazem), kiedy galeria jest w trybie pokazu slajdów',
    /* setting name */
    'Empty space below gallery' => 'Puste miejsce pod galerią',
    /* help text */
    'Distance between the gallery and the content below' => 'Odległość pomiędzy galerią i treścią pod nią',

    /* setting name */
    'Logo image' => 'Obraz logo',

    /* setting name */
    'Color when hovered' => 'Kolor rozświetlonego elementu',
    /* help text */
    'Color of the element under mouse cursor' => 'Kolor elementu, który znajduje się aktualnie pod strzałką myszki',
    /* setting name */
    'Color when selected' => 'Kolor aktywnego elementu',
    /* help text */
    'Color of the element of the currently opened section' => 'Kolor elementu obecnie otwartego działu',
    /* setting name */
    'Decoration' => 'Dekoracja',
    /* setting name */
    'Decoration when hovered' => 'Dekoracja rozświetlonego  elementu',
    /* setting name */
    'Decoration when selected' => 'Dekoracja aktywnego elementu',

    /* setting name */
    'Thumbnails' => 'Miniatury',
    /* setting name */
    'Thumbnails can be turned on by setting the section type to "Thumbnails enabled" & adding more than 1 images to background gallery.' => 'Miniatury mogą być włączone ustawiając typ rozdziały jako "Thumbnails enabled" oraz dodając więcej niż jedno zdjęcie do galerii tła.',
    /* setting name */
    'Thumbnail container width' => 'Szerokość kontenera miniatur',
    /* help text */
