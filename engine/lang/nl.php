...
return [
    ...
    'Sections' => 'Sections',
    /* column */
    'Title as displayed in main menu' => 'Titel zoals die in het hoofdmenu verschijnt',
    /* column */
    'Type' => 'Type',
    /* column */
    'Details' => 'Details',
    /* column */
    'Is published?' => 'is het gepubliceerd?',
    /* column */
    'Delete' => 'Delete',
    /* button */
    'create new section' => 'Maak nieuwe Section',
    /* button */
    'delete' => 'Delete',
    ...
    'Your name' => 'Jouw naam',
    /* help text */
    'Your name will be put in a meta-tag in the code of your site. You can choose any name ;)' => 'Jouw naam zal worden toegevoegd in een meta-tag in de code van jouw site. Je kan elke naam kiezen die je maar wilt ;)',
    /* setting name */
    'Page title (title bar)' => 'Paginatitel',
    /* help text */
    'Text that appears in the bowser title bar' => 'Tekst die verschijnt in de bowser title bar',
    /* setting name */
    ...
    /* setting name */
    'Is first section visible in menu?' => 'Is de eerste Section zichtbaar in het menu?',
    /* help text */
    ...
    /* setting name */
    'Show menu in first section?' => 'Toon menu in de eerste Section?',
    /* help text */
    'Choose "no" to hide the menu in first section.' => 'Kies "no" om het menu in de eerste Section te verbergen.',
    /* setting name */
    'Always auto-select a submenu item?' => 'Altijd automatisch een submenu-item selecteren?',
    /* help text */
    'Choose "yes" to automatically select the first submenu item when clicking on a menu item. This works only when there is a submenu.' => 'Kies "yes" om automatisch het eerste submenu-item te selecteren als je op een menu-item klikt. Dit werkt alleen als er een submenu-item is.',
    ...
    'Grid step' => 'Grid Step',
    /* help text */
    'Distance in pixels for snap-to-grid dragging.' => 'De afstand in pixels om gebruik te maken van het snap-to-grid systeem.',

    /* setting tab */
    'Entry layout' => 'Entry Layout',
    /* setting name */
    'Small image width' => 'Small image breedte',
    /* setting name */
    'Small image height' => 'Small image hoogte',
    /* help text */
    ...
    /* setting name */
    'Large image width' => 'Large image breedte',
    /* setting name */
    'Large image height' => 'Large image hoogte',
    /* help text */
    ...
    /* help text */
    'Positioning of the image caption text.' => 'Positionering van de image caption tekst.',
    /* setting subcategory */
    'Image gallery appearance:' => 'Image gallery appearance:',
    /* setting name */
    'Show slideshow image numbers' => 'Show slideshow image numbers',
    /* help text */
    'Set the default state of image number visibility in slideshow galleries.' => 'Zijn de image numbers zichtbaar in de slide show?',
    /* setting name */
    'Video player' => 'Video player',
    /* help text */
    'Choose between the two visually different players for your video files.' => 'Maak hier een keuze tussen twee qua uiterlijk verschillende videoplayers voor jouw videobestanden.',
    ...
    /* setting name */
    'Google site verification tag' => 'Google site verification tag',
    ...
    /* setting tab */
    'General font settings' => 'Algemene font settings',
    /* setting name */
    'Color' => 'Color',
    /* setting name */
    'Font face' => 'Font face',
    ...
    /* help text */
    'Height of text line. Use em, px or % values or the default value "normal"' => 'Ruimte tussen de regels tekst. Gebruik de units (eenheden) em, px of %, of de standaard waarde « normal ».',
    ...
    /* setting name */
    'Link color when hovered' => 'Link color when hovered',
    /* setting name */
    'Link color when clicked' => 'Link color when clicked',
    /* setting name */
    'Link decoration' => 'Link decoration',
    /* setting name */
    'Visited link decoration' => 'Visited link decoration',
    /* setting name */
    'Link decoration when hovered' => 'Link decoration when hovered',
    /* setting name */
    'Link decoration when clicked' => 'Link decoration when clicked',
    ...
    /* setting name */
    'Is background image enabled?' => 'Is de background image geactiveerd?',
    /* setting name */
    'Background image' => 'Background image',
    /* help text */
    'Picture to use for page background.' => 'Afbeelding die je als Background wilt gebruiken.',
    /* setting name */
    'Background tiling' => 'Background Tilen (herhalen in tegelpatroon) ?',
    /* help text */
    'How the background fills the screen?' => 'Hoe vult de Background het scherm? Horizontaal, verticaal of allebei?',
    /* setting name */
    'Background alignment' => 'Alignment van de Background.',
    /* help text */
    'Where the background image is positioned?' => 'Waar is de Background Image gepositioneerd?',
    /* setting name */
    'Background position' => 'Background position',
    /* help text */
    'Sets how background behaves in relation with the browser window.' => 'Hoe gedraagt de Background zich in  relatie tot de browser?.',

    /* setting name */
    'Background button type' => 'Background button type',
    /* help name */
    'Select type for background gallery buttons.' => 'Selecteer type voor background buttons.',
    /* setting name */
    'Centered layout' => 'Centered layout',
    /* help name */
    'Sets whether layout should be centered or not.' => 'Is de layout gecentreerd of juist niet?',

    /* setting name */
    'Centered content width' => 'Centered content breedte',
    /* help name */
    ...
    /* setting name */
    'Width of content area' => 'Breedte van de content area',
    /* setting name */
    'Page margins' => 'Page Margins',
    /* help text */
    'How far the content is from browser edges.' => 'Afstand tot de randen van de browser.',
    /* setting name */
    'Top menu margins' => 'Top menu margins',
    /* help text */
    'How big is the distance from the top menu to the other page elements' => 'Wat is de afstand van het Top menu tot de andere Page Elements?',
    ...
    /* help text */
    'Picture to use instead of text.' => 'Image Die je wilt gebruiken in plaats van tekst.',
    /* help text */
    'How far the heading is from other elements in page.' => 'Hoe ver is de heading van de andere elementen verwijderd? Zie ook korte CSS gids onderaan de pagina.',
    /* help text */
    'How far the menu is form other elements in page.' => 'Hoe ver is het menu van de andere elementen verwijderd? Zie ook korte CSS gids onderaan de pagina.',

    /* setting tab */
    'Main menu' => 'Main menu',
    /* setting name */
    'Menu items separator' => 'Separator (leesteken) tussen de menu-items',
    /* setting name */
    'Space width around separator' => 'Ruimte rond Separator',
    /* help text */
    'The distance from the separator to the menu item on both sides' => 'Afstand van separator tot menu-items aan beide kanten.',

    /* setting tab */
    'Submenu' => 'Submenu',

    /* setting name */
    'Entry margins' => 'Margins (marges)',
    /* help text */
    'Margins around entries.' => 'Margins rond entries. Zie ook korte CSS gids onderaan de pagina.',
    /* setting name */
    'Gallery position' => 'Gallery positie',
    /* setting name */
    'Default gallery type' => 'Standaard gallery type',
    /* help text */
    'Slideshow means that an image menu plus only one image is visible at a time. Row means that all images are visible.' => 'Slideshow betekent dat een image menu plus alleen maar een image zichtbaar is. Row betekent dat alle images zichtbaar zijn.',
    /* setting name */
    'Space between images in row and column' => 'Ruimte tussen images in row en column',
    /* help text */
    'Horizontal/vertical space between images when gallery is in "row"/"column" mode' => 'De horizontale/verticale ruimte tussen de images als de gallery in "Row"/"Column" mode staat.',
    /* setting name */
    'Gallery margins' => 'Gallery margins (marges)',
    /* help text */
    'Margin around gallery block' => 'Margin rond gallery block',

    /* setting tab */
    'Entry heading' => 'Entry heading',
    /* help text */
    'How far the entry heading is form other elements in page.' => 'Hoe ver is de entry heading van de andere elementen in de pagina verwijderd? Zie ook korte CSS gids onderaan de pagina.',
    ...
    /* setting name */
    'Entry text max width' => 'Maximale breedte van entry tekst',
    /* help text */
    'Width of texts in the entries. This does not apply to the width of images.' => 'Breedte van de teksten in de entries. Is niet van toepassing op de breedte van de pagina',
    /* setting name */
    'How far content is from page top?' => 'Hoe ver staat de content van de top af?',
    /* help text */
    'The vertical distance between the top of the page and the content area.' => 'Verticale afstand van de top van de pagina tot content area.',
    /* setting name */
    'How far content is from sidebar?' => 'Hoever is de content van de sidebar verwijderd?',
    /* help text */
    'The horizontal distance between the menu and the content area.' => 'Horizontale afstand tussen menu en content area.',

    /* setting name */
    'Space between entries' => 'Ruimte tussen de Entries',
    /* help text */
    'Distance from entry to entry. In pixels.' => 'Ruimte tussen entries, in pixels.',
    ...
    /* help text */
    'How far the sidebar is from the left side of the screen. This gets ignored, if centered layout is enabled.' => 'Hoever is de sidebar van de linkerkant van het scherm verwijderd? Dit is niet van toepassing als "centered layout" aan staat.',
    /* setting name */
    'Top padding' => 'Top padding',
    /* help text */
    'How far the header is from the top of the screen?' => 'Hoever de header van de bovenkant van het scherm verwijderd is.',
    /* setting name */
    'Space between header and menu' => 'Ruimte tussen header en menu',
    /* help text */
    'How far the menu is from the header text or header image.' => 'Hoe ver is het menu van de header tekst of header image verwijderd?',
    /* setting name */
    'Heading text color' => 'Heading text color',
    /* setting name */
    'Is transparent?' => 'Transparant ?',
    /* setting name */
    ...
    /* setting name */
    'Heading font variant' => 'SmallCaps',
    /* setting name */
    'Heading line height' => 'Heading line height',

    /* setting name */
    'Image size ratio' => 'Image size ratio',
    /* help text */
    'Images in the first page layout will be resized by this ratio. Think of it as percentage, e.g., 0.7 = 70% of the original image size.' => 'Images op de eerste pagina worden geschaald naar deze verhouding. Zie het als een percentage: 0.7 = 70% van de oorspronkelijke image size.',
    /* setting name */
    'Images have shadows?' => 'Hebben de images een schaduw?',
    /* setting name */
    'Images wiggle on mouse-over?' => 'Wiebelen de images bij mouse-over?',

    /* setting name */
    'Color when opened' => 'Kleur indien open',
    /* setting name */
    'Decoration when opened' => 'Decoration indien open (underline, overline, etc.)',

    // Translations for White template

    /* setting name */
    'Empty space on top' => 'Lege ruimte bovenin',
    /* setting name */
    'Empty space on bottom' => 'Lege ruimte onderin',
    /* setting name */
    'How far content is from menu?' => 'Afstand van de content tot het menu',
    /* setting name */
    'Width of the left column' => 'Breedte van de linkerkolom',

    // Translations for Messy template

    /* setting name */
    'Space between images and image navigation' => 'Afstand tussen de images en de image navigatie',
    /* help text */
    'Vertical space between images and image navigation (the digits below the image) when gallery is in "slideshow" mode' => 'Verticale ruimte tussen afbeeldingen en afbeeldingsnavigatie (de cijfers onder de afbeelding) als de gallery in "slideshow" mode staat.',
    /* setting name */
    'Empty space below gallery' => 'Lege ruimte onder de gallery',
    /* help text */
    'Distance between the gallery and the content below' => 'Afstand tussen de gallery en de content er onder',

    /* setting name */
    'Logo image' => 'Logo image',

    /* setting name */
    'Color when hovered' => 'Color bij mouse-over',
    /* help text */
    'Color of the element under mouse cursor' => 'Color van het element onder de cursor.',
    /* setting name */
    'Color when selected' => 'Color bij selectie',
    /* help text */
    'Color of the element of the currently opened section' => 'Color van de section die geselecteerd is.',
    /* setting name */
    'Decoration' => 'Decoration',
    /* setting name */
    'Decoration when hovered' => 'Decoration bij mouse-over',
    /* setting name */
    'Decoration when selected' => 'Decoration indien geselecteerd',

    /* setting name */
    'Thumbnails' => 'Thumbnails',
    /* setting name */
    'Thumbnails can be turned on by setting the section type to "Thumbnails enabled" & adding more than 1 images to background gallery.' => 'Thumbnails kunnen worden aangezet door het Section Type naar "Thumbnails enabled" te zetten en meer dan een image aan de background gallery toe te voegen.',
    /* setting name */
    'Thumbnail container width' => 'Thumbnail container breedte',
    /* help text */
