...
return array(
        ...
        'berta_copyright_text' => '<a href="http://www.berta.me/" target="_blank" title="Создайте собственное портфолио за считанные минуты с Berta!">berta</a>',
        ...
        /* menu item */ 'template design' => 'дизайн шаблона',
        /* menu item */ 'profile' => 'профиль',
        /* menu item */ 'sign out' => 'выйти',
        ...
        'welcome_text__not_installed' => '<h2>Благодарим,<br/>что выбрали Berta!</h2>
                                                                          <p>Berta не установлена.<br />Пожалуйста <a href="./engine/">войдите</a> и следуйте процедуре установки.</p>',
        ...
        'Retype new password' => 'Новый пароль еще раз',
        'Change password' => 'Сменить пароль',
        'password_help_text' => 'Пароль должен состоять минимум из 6 символов <br /> и содержать только большие/маленькие латинские буквы и/или цифры(A-Z, a-z, 0-9).',
        '' => '',

        // Translations from settings page (settings.php)

        /* title */ 'Settings' => 'Настройки',
        /* title */ 'Template design' => 'Шаблон',
        'These are settings for template' => 'Это настройки шаблона',

        'Some help with CSS values' => 'Объяснение значений CSS',
        'Units' => 'Единицы',
        'units_help_text' => 'Можно использовать следующие единицы: <br /><strong>px</strong> – пиксели<br /><strong>em</strong> - 1 em = ширина одной буквы M в определенном шрифте<br /><strong>%</strong> - проценты размера шрифта или проценты размера элемента контейнера',
        'Margins' => 'Поля отступа',
        'margins_help_text' => 'Есть 4 способа, как можно вводить размер отступов:<br/><strong>1 значение</strong> – задает размер верхнего, правого, нижнего и левого отступа одного размера. Например, <em>10px</em>.<br /><strong>2 значения</strong> – первая цифра задает размер верхнего и нижнего отступа, вторая – размер правого и левого отступа. Например: <em>0 5px</em>.<br /><strong>3 значения</strong> – первая цифра определяет размер верхнего отступа, вторая – правого и левого отступа, а третья – размер нижнего отступа. Например: <em>10px 0 20px</em>.<br /><strong>4 значения</strong> - определяет размеры всех отступов в следующем порядке: верх, правая сторона, низ, левая сторона. Например: <em>10px 0 20px 2px</em>',
    ...
    /* help text */    'Choose "no" to hide the menu in first section.' => ' Выберите "нет", чтобы спрятать меню на первой странице.',
        ...
        /* setting name */ 'Image frame' => 'Рамка изображения',
        /* help text */    'Enables/Disables a frame around image.' => 'Включить/выключить рамку изображения.',
    ...
    /* help text */    'Horizontal/vertical space between images when gallery is in "row"/"column" mode' => 'Горизонтальное/вертикальное расстояние между изображениями, когда галерея активна в режиме ряд/колонка',
        ...
        /* setting name */ 'Display tags by each entry' => 'Выводить тэги для каждой записи',
        /* help text */    'This determines whether people will see tags you set for each entry. Regardless of this settting, tags still will make up the main menu.' => 'Определяет, если нужно выводить тэги для каждой записи. Вне зависимости от настроек, тэги будут выводиться в главном меню.',
        /* setting name */ 'Date format in entries' => 'Формат даты для записей',
        /* setting name */ 'Date separator' => 'Разделитель даты',
        /* help text */    'Separator symbol that divides year, month and day' => 'Символ, который будет разделять год, месяц, день',
        /* setting name */ 'Time separator' => 'Разделитель времени',
...
*/
        ...
        'Show this window on startup' => 'Всегда показывать данное окно при входе в систему',
        'Close' => 'Закрыть',
