...
var FancyUpload2 = new Class({
	...
	render: function() {
		this.overallTitle = new Element('SPAN'); //this.status.getElement('.overall-title');
		this.currentTitle = new Element('SPAN'); //this.status.getElement('.current-title');
		this.currentText = new Element('SPAN'); //this.status.getElement('.current-text');

		var progress = new Element('SPAN'); //this.status.getElement('.overall-progress');
		this.overallProgress = new Fx.ProgressBar(progress, {
			text: new Element('span', {'class': 'progress-text'}).inject(progress, 'after')
		});
		progress = new Element('SPAN'); //this.status.getElement('.current-progress')
