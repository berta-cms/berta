...
var BertaGalleryFullscreen=function(e,t){function i(){s.querySelectorAll("video").forEach(function(e){e.pause()})}var l,r,a=[],o=e.querySelectorAll(".xGalleryItem"),n=null!==e.querySelector("[data-swiper-slide-index]"),e=(e.querySelectorAll(".xGalleryNav > li > a").forEach(function(e,t){e=e.classList.contains("xType-image")?{originalImage:{src:e.getAttribute("data-original-src"),w:parseInt(e.getAttribute("data-original-width"),10),h:parseInt(e.getAttribute("data-original-height"),10)},mobileImage:{src:e.getAttribute("data-mobile-src"),w:parseInt(e.getAttribute("data-mobile-width"),10),h:parseInt(e.getAttribute("data-mobile-height"),10)},title:e.getNext(".xGalleryImageCaption").innerHTML}:{html:o[t+(n?1:0)].outerHTML};a.push(e)}),{loop:"yes"===bertaGlobalOptions.slideshowAutoRewind,index:t,counterEl:"yes"===bertaGlobalOptions.galleryFullScreenImageNumbers,history:!1,clickToCloseNonZoomable:!1,shareButtons:[{id:"facebook",label:"Share on Facebook",url:"https://www.facebook.com/sharer/sharer.php?u={{url}}"},{id:"twitter",label:"Tweet",url:"https://twitter.com/intent/tweet?text={{text}}&url={{url}}"},{id:"pinterest",label:"Pin it",url:"http://www.pinterest.com/pin/create/button/?url={{url}}&media={{image_url}}&description={{text}}"}]}),s=document.querySelectorAll(".pswp")[0],u=!1,c=!0,g=new PhotoSwipe(s,PhotoSwipeUI_Default,a,e);g.listen("beforeResize",function(){l=g.viewportSize.x*window.devicePixelRatio,u&&l<425?r=!(u=!1):!u&&425<=l&&(r=u=!0),r&&!c&&g.invalidateCurrItems(),c=c&&!1,r=!1}),g.listen("gettingData",function(e,t){t.html||(u?(t.src=t.originalImage.src,t.w=t.originalImage.w,t.h=t.originalImage.h):(t.src=t.mobileImage.src,t.w=t.mobileImage.w,t.h=t.mobileImage.h))}),g.init();g.listen("beforeChange",i),g.listen("close",i)};
...
Element.implement({getIndex:function(e){return e=e||"",$$(e).indexOf(this)},exists:function(){return this},getClassStoredValue:function(e){for(var t=this.get("class").split(" "),i=0;i<t.length;i++)if(t[i].substr(0,t[i].indexOf("-"))==e)return t[i].substr(t[i].indexOf("-")+1);return null},setClassStoredValue:function(e,t){this.get("class").split(" ");var i=this.getClassStoredValue(e);i&&this.removeClass(e+"-"+i),this.addClass(e+"-"+t)}});var Berta=new Class({Implements:Options,options:{paths:null,playerType:"JWPlayer",iframeWrapperWhiteList:["youtube","vimeo"]},entriesList:null,initialize:function(e){this.setOptions(e),window.addEvent("domready",this.onDOMReady.bindWithEvent(this)),window.addEvent("load",this.onLoad.bindWithEvent(this)),window.console||(window.console={debug:function(){},log:function(){}})},onDOMReady:function(e){this.entriesList=$$(".xEntriesList"),this.entriesList&&(this.entriesList=this.entriesList[0]),this.windowResizeEvents()},onLoad:function(e){this.initEntriesList()},initEntriesList:function(){$$(".xEntriesList .xGalleryContainer").each(function(e){e.getParent(".xEntry").hasClass("xHidden")||this.initGallery(e)}.bind(this))},initGallery:function(e){switch(e.getClassStoredValue("xGalleryType")){case"row":new BertaGalleryRow(e);break;case"column":new BertaGalleryColumn(e);break;case"pile":new BertaGalleryPile(e);break;case"link":new BertaGalleryLink(e);break;default:new BertaGallerySlideshow(e)}},windowResizeEvents:function(){function e(){var e,t=window.getSize().x,i=window.getSize().y,n=$("sideColumn"),s=$("sideColumnTop"),o=$("sideColumnBottom");o&&(s=s.getSize().y,e=o.getSize().y,a&&t<l||i<s+e?(n.setStyle("position","absolute"),o.setStyle("position","static")):(n.setStyle("position","fixed"),o.setStyle("position","absolute")))}var t,a,l,i,n,s;"mashup"!=(t=this.options.templateName.split("-")[0])&&"white"!=t||(a=$$(".xResponsive").length,l=767,e.delay(1e3),$(window).addEvent("resize",e));(s=$("menuToggle"))&&(i=s.getNext(),s.addEvent("click",function(e){e.preventDefault(),i.toggle(),this.toggleClass("active")}),window.addEvent("resize",function(){n!=window.getSize().x&&(n=window.getSize().x,767<this.getSize().x?i.show():(s.removeClass("active"),i.hide()))}),n=window.getSize().x,window.fireEvent("resize"))}});window.berta=new Berta(window.bertaGlobalOptions);
