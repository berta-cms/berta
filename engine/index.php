...
<body class="bt-content-editor page-xMySite">
    ...
    <iframe sandbox="allow-same-origin allow-scripts allow-modals" src="<?php echo $ENGINE_ROOT_URL ?>editor/index.php<?php echo $site ? "?site=$site" : '' ?>" frameborder="0" style="width:100%;height:100%;"></iframe>
    <script>
        (function(){
