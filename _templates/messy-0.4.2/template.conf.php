...
$templateConf = [
    ...
    'heading' => [
        ...
        'fontFamily' => [
            'format' => 'fontselect',
            'values' => $fontOptionsWithInherit, 'default' => '"Arial black", Gadget',
            'title' => I18n::_('Font face'),
            'description' => '',
        ],
        'googleFont' => [
            'format' => 'text',
            'default' => '',
            'html_entities' => true, 'title' => 'Google web fonts',
            'description' => I18n::_('googleFont_description'),
        ],
        'fontSize' => [
            'format' => 'text',
            'css_units' => true, 'default' => '30px',
            'title' => I18n::_('Font size'),
            'description' => '',
        ],
        'fontWeight' => [
    ...
    'entryHeading' => [
        ...
        'fontFamily' => [
            'format' => 'fontselect',
            'values' => $fontOptions, 'default' => 'Arial, sans-serif',
            'title' => I18n::_('Font face'),
            'description' => '',
        ],
        'googleFont' => [
    ...
    'entryLayout' => [
        ...
        'contentWidth' => [
            'format' => 'text',
            'default' => '400px',
            'css_units' => true, 'title' => I18n::_('Entry text max width'),
            'description' => '',
        ],
        'defaultGalleryType' => [
            'format' => 'select',
        ...
        'spaceBetweenImages' => [
            'format' => 'text',
            'default' => '1em',
            'css_units' => true, 'title' => I18n::_('Space between images in row and column'),
            'description' => I18n::_('Horizontal/vertical space between images when gallery is in "row"/"column" mode'),
        ],
        'galleryNavMargin' => [
            'format' => 'text',
            'default' => '0',
            'css_units' => true, 'title' => I18n::_('Space between images and image navigation'),
        ...
        'galleryMargin' => [
            'format' => 'text',
            'default' => '0',
            'css_units' => true, 'title' => I18n::_('Empty space below gallery'),
    ...
    'css' => [
        ...
        'customCSS' => [
            ...
            'html_entities' => true, 'title' => I18n::_('Custom CSS'),
