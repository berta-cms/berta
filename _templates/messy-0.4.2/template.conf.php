...
$templateConf = array(
    ...
    'pageLayout' => array(
        ...
        'autoResponsive' =>	array('format' => 'select', 'default' => 'yes', 'values' => array('yes', 'no'), 'title' => I18n::_('Responsive layout'), 'description' => I18n::_('Enables responsive layout for mobile devices.')),
        'responsive' =>	array('format' => 'select', 'default' => 'no', 'values' => array('no', 'yes'), 'title' => I18n::_('Grid layout'), 'description' => I18n::_('Entries are organised in columns. Column count can be changed under section settings.')),
