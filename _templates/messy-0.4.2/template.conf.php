...
$templateConf = array(
	...
	'pageLayout' => array(
        ...
        'autoResponsive' =>	array('format' => 'select', 'default' => 'yes', 'values' => array('yes', 'no'), 'title' => I18n::_('Auto responsive layout.')),
		'responsive' =>	array('format' => 'select', 'default' => 'no', 'values' => array('no', 'yes'), 'title' => I18n::_('Responsive layout')),
