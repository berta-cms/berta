...
$templateConf = [
    'generalFontSettings' => [
        ...
        'color' => ['format' => 'color',		'default' => '#333333', 							                            'title' => I18n::_('Color'),             'description' => ''],
        'fontFamily' => ['format' => 'fontselect',	'values' => $fontOptions, 'default' => reset($fontOptions), 	'title' => I18n::_('Font face'),         'description' => ''],
        'googleFont' => ['format' => 'text',		'default' => '', 'html_entities' => true,										'title' => 'Google web fonts',         'description' => I18n::_('googleFont_description')],
        'fontSize' => ['format' => 'text', 'css_units' => true, 'default' => '9pt', 								                            'title' => I18n::_('Font size'),         'description' => ''],
    ...
    'links' => [
        ...
        'colorLink' => ['format' => 'color',		'default' => '#888888', 	    'title' => I18n::_('Link color'),                'description' => ''],
        'colorVisited' => ['format' => 'color',		'default' => '#888888', 	'title' => I18n::_('Visited link color'),        'description' => ''],
        'colorHover' => ['format' => 'color',		'default' => '#888888', 	'title' => I18n::_('Link color when hovered'),   'description' => ''],
        'colorActive' => ['format' => 'color',		'default' => '#888888', 	'title' => I18n::_('Link color when clicked'),   'description' => ''],
    ...
    'pageLayout' => [
        ...
        'contentPosition' => ['format' => 'select',		'values' => ['left', 'center', 'right'], 		'default' => 'left', 				            'title' => I18n::_('Content position'),         'description' => ''],
        'contentAlign' => ['format' => 'select',		'values' => ['left', 'right', 'justify-left', 'justify-right'], 	'default' => 'left',        'title' => I18n::_('Text alignment'),           'description' => ''],
        'contentWidth' => ['format' => 'text',		'default' => '500px', 'css_units' => true,			                                                'title' => I18n::_('Width of content area'),    'description' => ''],
        'bodyMargin' => ['format' => 'text',		'default' => '20px 40px 40px', 'css_units' => true,	                                                'title' => I18n::_('Page margins'),             'description' => I18n::_('How far the content is from browser edges. Please see the short CSS guide at the bottom of this page.')],
        'siteMenuMargin' => ['format' => 'text',		'default' => '0', 'css_units' => true,			                                                'title' => I18n::_('Top menu margins'),         'description' => I18n::_('How big is the distance from the top menu to the other page elements')],
    ...
    'pageHeading' => [
        ...
        'image' => ['format' => 'image',		'default' => '', 'min_width' => 1, 'min_height' => 1, 'max_width' => 1000, 'max_height' => 1000, 	'title' => I18n::_('Header image'),  'description' => '<span class="warning">' . I18n::_('Displayed image will be half of the original size, full size will be used for hi-res displays.') . '</span>'],
        'color' => ['format' => 'color',		'default' => '#333333', 					                                                        'title' => I18n::_('Color'),         'description' => ''],
        'fontFamily' => ['format' => 'fontselect',	'values' => $fontOptionsWithInherit, 'default' => 'inherit', 			                        'title' => I18n::_('Font face'),     'description' => ''],
        'googleFont' => ['format' => 'text',		'default' => '', 'html_entities' => true,															'title' => 'Google web fonts',         'description' => I18n::_('googleFont_description')],
        'fontSize' => ['format' => 'text', 'css_units' => true, 'default' => '1.2em', 					                                                            'title' => I18n::_('Font size'),     'description' => ''],
        'fontWeight' => ['format' => 'select',		'values' => ['normal', 'bold'], 'default' => 'bold', 				                            'title' => I18n::_('Font weight'),   'description' => ''],
        'fontStyle' => ['format' => 'select',		'values' => ['normal', 'italic'], 'default' => 'normal', 			                            'title' => I18n::_('Font style'),    'description' => ''],
        'fontVariant' => ['format' => 'select',		'values' => ['normal', 'small-caps'], 'default' => 'normal', 		                            'title' => I18n::_('Font variant'),  'description' => ''],
        'lineHeight' => ['format' => 'text', 'css_units' => true, 'default' => '0.8em', 					                                                            'title' => I18n::_('Line height'),   'description' => I18n::_('Height of text line. Use em, px or % values or the default value "normal"')],
        'margin' => ['format' => 'text', 'css_units' => true, 'default' => '10px 0 15px', 			                                                            'title' => I18n::_('Margins'),       'description' => I18n::_('How far the heading is from other elements in page. Please see the short CSS guide at the bottom of this page.')],
    ],

    'menu' => [
        '_' => ['title' => I18n::_('Main menu')],
        'separator' => ['format' => 'text',		'default' => '|', 						                                    'title' => I18n::_('Menu items separator'),              'description' => ''],
        'separatorDistance' => ['format' => 'text', 'css_units' => true, 'default' => '0.5em', 					                                        'title' => I18n::_('Space width around separator'),      'description' => I18n::_('The distance from the separator to the menu item on both sides')],
        'fontSize' => ['format' => 'text', 'css_units' => true, 'default' => 'inherit', 				                                    'title' => I18n::_('Font size'),                         'description' => ''],
        'fontFamily' => ['format' => 'fontselect',		'values' => $fontOptionsWithInherit, 'default' => 'inherit', 	        'title' => I18n::_('Font face'),                         'description' => ''],
        'googleFont' => ['format' => 'text',		'default' => '', 'html_entities' => true,									'title' => 'Google web fonts',         'description' => I18n::_('googleFont_description')],
        'colorLink' => ['format' => 'color',		'default' => '#888888', 	                                                'title' => I18n::_('Color'),                 'description' => ''],
        'colorHover' => ['format' => 'color',		'default' => '#888888', 	                                                'title' => I18n::_('Color when hovered'),    'description' => I18n::_('Color of the element under mouse cursor')],
        'colorActive' => ['format' => 'color',		'default' => '#888888', 	                                                'title' => I18n::_('Color when selected'),   'description' => I18n::_('Color of the element of the currently opened section')],
        'fontWeight' => ['format' => 'select',		'values' => ['inherit', 'normal', 'bold'], 'default' => 'inherit',     'title' => I18n::_('Font weight'),                       'description' => ''],
        ...
        'margin' => ['format' => 'text', 'css_units' => true, 'default' => '0', 				                                            'title' => I18n::_('Margins'),                           'description' => I18n::_('How far the menu is form other elements in page. Please see the short CSS guide at the bottom of this page.')]
    ],
    ...
    'entryLayout' => [
        ...
        'galleryPosition' => ['format' => 'select',	'values' => ['between title/description', 'above title', 'below description'], 'default' => 'between title/description',       'title' => I18n::_('Gallery position'),             'description' => ''],
        ...
        'galleryMargin' => ['format' => 'text', 'css_units' => true, 'default' => '0',                                                                                                                   'title' => I18n::_('Gallery margins'), 	            'description' => I18n::_('Margin around gallery block')],
    ],
    ...
    'entryHeading' => [
        ...
        'fontVariant' => ['format' => 'select',		'values' => ['normal', 'small-caps'], 'default' => 'normal', 		        'title' => I18n::_('Font variant'),      'description' => ''],
        'lineHeight' => ['format' => 'text', 'css_units' => true, 'default' => 'normal', 					                                        'title' => I18n::_('Line height'),       'description' => I18n::_('Height of text line. Use em, px or % values or the default value "normal"')],
        'margin' => ['format' => 'text', 'css_units' => true, 'default' => '0', 						                                        'title' => I18n::_('Margins'),           'description' => I18n::_('How far the entry heading is form other elements in page. Please see the short CSS guide at the bottom of this page.')],
    ],

    'entryFooter' => [
        '_' => ['title' => I18n::_('Entry footer')],
        'color' => ['format' => 'color',		'default' => '#333333', 					                                'title' => I18n::_('Color'),             'description' => ''],
        'fontFamily' => ['format' => 'fontselect',		'values' => $fontOptionsWithInherit, 'default' => 'inherit', 			'title' => I18n::_('Font face'),         'description' => ''],
        'googleFont' => ['format' => 'text',		'default' => '', 'html_entities' => true,									'title' => 'Google web fonts',         'description' => I18n::_('googleFont_description')],
        'fontSize' => ['format' => 'text',  'css_units' => true, 'default' => 'inherit', 					                                'title' => I18n::_('Font size'),         'description' => ''],
