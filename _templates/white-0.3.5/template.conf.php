...
$templateConf = [
    ...
    'links' => [
        ...
        'colorHover' => ['format' => 'color',		'default' => '#666666', 	'title' => I18n::_('Link color when hovered'),   'description' => ''],
        'colorActive' => ['format' => 'color',		'default' => '#666666', 	'title' => I18n::_('Link color when clicked'),   'description' => ''],
    ...
    'pageHeading' => [
        ...
        'marginTop' => ['format' => 'text',		'default' => '0', 				'css_units' => true,                    'title' => I18n::_('Empty space on top'),                        'description' => ''],
