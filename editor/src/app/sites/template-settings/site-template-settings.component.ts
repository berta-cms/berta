...
@Component({
  ...
  template: `
    <div class="setting-group"
      ...
      <h3 [routerLink]="['/design', camelifySlug(currentGroup) === settingGroup.slug ? '' : slugifyCamel(settingGroup.slug)]" queryParamsHandling="preserve" role="link" class="hoverable">
