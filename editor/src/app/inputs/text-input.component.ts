  ...
  >
    <label>
      <span class="label-text">
        ...
        ><span [innerHTML]="disabledReason"></span>
      </span>
      <div class="text-input-wrapper">
        <svg
          *ngIf="textInputService.showIcon | async"
          class="icon-empty"
...
export class TextInputComponent implements OnInit {
  ...
  @Input() cssUnitsRequired?: boolean;
  ...
  ngOnInit() {
    ...
    this.textInputService.value
      .pipe(
        filter((value) => {
          const validate = this.validationService.validate(
            value,
            this.allowBlank,
