          ...
          <div class="image-container">
            ...
            <a href="#" class="apply" (click)="applyTheme($event, theme.name)">
              <span>
                <svg
                  height="19.999998"
                  viewBox="0 0 26.819992 19.999998"
                  width="26.819992"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
                    d="m9.1092592 19.607203-8.71650571-8.71651c-.52367132-.52367-.52367132-1.3727405 0-1.8964705l1.89641621-1.89647c.5236713-.52372 1.3727972-.52372 1.8964686 0l5.8718547 5.8718105 12.57686-12.5768105c.523671-.52367 1.372797-.52367 1.896469 0l1.896416 1.89647c.523671.52367.523671 1.37274 0 1.89647l-15.42151 15.4215605c-.523724.52367-1.3727975.52367-1.8964688-.00005z"
                    fill="#a2afff"
                    stroke-width=".052383"
                  ></path>
                </svg>
...
export class ThemesComponent implements OnInit {
      ...
      .subscribe({
        next: () => {
          const url =
            ...
            (this.appState.site ? '/' + this.appState.site : '') +
            '?preview=1';
  ...
  applyTheme(event, theme) {
    ...
    this.popupService.showPopup({
      type: 'warn',
      content:
        "Are you sure you want to apply this theme? All design related settings will be overwritten and can't be undone!",
      showOverlay: true,
      actions: [
        {
          type: 'primary',
