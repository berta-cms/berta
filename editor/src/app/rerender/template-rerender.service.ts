...
import {removeExtraAddBtnAndAddListeners, replaceContent} from "./utilities/content";
...
export class TemplateRerenderService {
  ...
  private static getSiteSettingsChildrenComp(action: HandleSiteSettingsChildrenChangesAction, info: SiteSettingChildrenHandler): Component[] {
  ...
  protected static handleCssDesignSettingChange(dom: Document, action: HandleSiteTemplateSettingsAction) {
  ...
  public handleEntryCreationRerender(iframe: HTMLIFrameElement): Subscription {
    return this.actions$.pipe(ofActionSuccessful(
      ...
      () => {
        ...
        replaceContent(iframe.contentDocument, 'portfolioThumbnails', viewData.portfolioThumbnails)
  ...
  public handleSectionEntryUpdateRerender(iframe: HTMLIFrameElement): Subscription {
    return this.actions$.pipe(ofActionSuccessful(
  ...
  public handleSiteSettingChildrenHandleRerender(iframe: HTMLIFrameElement, info: SiteSettingChildrenHandler): Subscription {
    return this.actions$.pipe(ofActionSuccessful(
