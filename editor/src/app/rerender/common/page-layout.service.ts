...
export class PageLayoutService {
  handle(iframe: HTMLIFrameElement, viewData) {
    ...
    PageLayoutService.handleIsResponsiveSetting(dom, sideColumn, mainColumn, viewData)
  ...
  protected static handleIsResponsiveSetting(dom: Document, sideColumn: HTMLElement, mainColumn: HTMLElement, viewData) {
